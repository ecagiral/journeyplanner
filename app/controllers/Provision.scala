...
object Provision extends Controller with Secured{
  ...
  def editEdge = withAuth { username => implicit request =>
     ...
     def dummyResponse(id:Long) = Action{ implicit request =>
       val res = Json.obj("id" -> id,"name" -> "dummy","price" -> "15.50","image"-> "http://www.ofix.com/UserFiles/Document/S12828_8b9_c60.jpg","url"->"http://www.ofix.com/Urunler/020922/Scrikss-F-108-Tukenmez-Kalem/S12828")
       Ok(Json.toJson(res))       
     }
}
